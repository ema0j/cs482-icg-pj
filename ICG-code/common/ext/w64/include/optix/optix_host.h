...
typedef optix::Acceleration             * RTacceleration;
typedef optix::Buffer                   * RTbuffer;
 ...
 ***********************************/
  ...
  RTresult RTAPI rtBufferCreate         (RTcontext context, RTbuffertype type, RTbuffer* buffer);
