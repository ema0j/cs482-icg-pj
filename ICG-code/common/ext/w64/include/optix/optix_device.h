...
namespace optix {
  ...
  private:
    __inline__ __device__ uint4 make_index(unsigned int v0) { return make_uint4(v0, 0, 0, 0); }
    __inline__ __device__ uint4 make_index(uint2 v0) { return make_uint4(v0.x, v0.y, 0, 0); }
    __inline__ __device__ uint4 make_index(uint3 v0) { return make_uint4(v0.x, v0.y, v0.z, 0); }
    __inline__ __device__ uint4 make_index(uint4 v0) { return make_uint4(v0.x, v0.y, v0.z, v0.w); }
  };
}
