...
extern "C" {
  ...
  */
 RTresult rtuGroupRemoveChildByIndex        ( RTgroup group, unsigned int index );
 RTresult rtuSelectorRemoveChildByIndex     ( RTselector selector, unsigned int index );
 RTresult rtuGeometryGroupRemoveChildByIndex( RTgeometrygroup geometrygroup, unsigned int index );
  ...
  */
 RTresult rtuGroupGetChildIndex        ( RTgroup group, RTobject child, unsigned int* index );
 RTresult rtuSelectorGetChildIndex     ( RTselector selector, RTobject child, unsigned int* index );
 RTresult rtuGeometryGroupGetChildIndex( RTgeometrygroup geometrygroup, RTgeometryinstance child, unsigned int* index );
