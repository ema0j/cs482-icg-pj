...
#ifndef __optix_optixu_matrix_h__
#define __optix_optixu_matrix_h__
...
namespace optix {
  ...
  MAT_DECL Matrix<M,N>& operator+=(Matrix<M,N>& m1, const Matrix<M,N>& m2);
  MAT_DECL Matrix<M,N>& operator*=(Matrix<M,N>& m1, float f);
  MAT_DECL Matrix<M,N>& operator/=(Matrix<M,N>& m1, float f);
  MAT_DECL Matrix<M,N> operator-(const Matrix<M,N>& m1, const Matrix<M,N>& m2);
  MAT_DECL Matrix<M,N> operator+(const Matrix<M,N>& m1, const Matrix<M,N>& m2);
  MAT_DECL Matrix<M,N> operator/(const Matrix<M,N>& m, float f);
  MAT_DECL Matrix<M,N> operator*(const Matrix<M,N>& m, float f);
  MAT_DECL Matrix<M,N> operator*(float f, const Matrix<M,N>& m);
...
#endif //  __optix_optixu_matrix_h__
